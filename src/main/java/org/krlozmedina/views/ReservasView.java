...
//	}
	...
	public ReservasView() {
		...
		lblCheckOut.setBounds(68, 221, 237, 14);
		...
		lblTitulo.setBounds(109, 60, 269, 42);
		...
		lblValor.setBounds(72, 303, 246, 14);
		...
		txtFechaEntrada.setDateFormatString("dd-MMMM-yyyy");
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if (txtFechaSalida.getDate() != null) {
					long milliSecondsByDay = 86400000;
					long diffDate = txtFechaSalida.getDate().getTime() - txtFechaEntrada.getDate().getTime();
					long diffByDay = diffDate / milliSecondsByDay;
					txtValor.setText(String.valueOf(diffByDay * 50000));
				}
			}
		});
		txtFechaSalida.setDateFormatString("dd-MMMM-yyyy");
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {
					if (Integer.valueOf(txtValor.getText()) > 0) {
						...
						JOptionPane.showMessageDialog(null, "Verificar el rango de fechas");
					}
				} else {
